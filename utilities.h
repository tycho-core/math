...
namespace math
{
    ...
    //@{
    inline core::float32 deg_to_rad(core::float32 deg) { return deg * PI_F / 180.f; }
    inline core::float32 rad_to_deg(core::float32 rad) { return rad * 180.f / PI_F; }
    //@}
    ...
    /// \name conversion functions
    //@{
    inline core::float64 deg_to_rad(core::float64 deg) { return deg * PI / 180.0; }
    inline core::float64 rad_to_deg(core::float64 rad) { return rad * 180.0 / PI; }
    //@}
